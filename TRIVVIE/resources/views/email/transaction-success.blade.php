                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                    <tbody>
                                        <tr>
                                            <td
                                                style="border-bottom:1-x dhased #eee;vertical-align:middle;padding-bottom:30px;">
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    style="" width="100%">
                                                    <tbody>
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    kamu sudah berhasil dicetak. <br> Booking ID
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="width:50px;">
                                                            <img src="{{ url('frontend/images/ic_support.png') }}"
                                                                width="50px">
                                                        </td>
                                                        <td
                                                            style="font-size: 18px; paddding-left: 10px; color: #071C4D; font-family:Assistant, Helvetica, Arial, sans-serif;">
                                                            support@trivvie.id <br> 021-2022-2019 </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#888B93;">
                                                    2022 Trivvie Copyright All Rights Reserved.</div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
