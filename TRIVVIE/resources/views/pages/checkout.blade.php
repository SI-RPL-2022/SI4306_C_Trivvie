    ...
    <div class="container">
        ...
        <div class="col-lg-8 pl-lg-0">
            ...
            <div class="attendee">
                ...
                <tbody>
                    ...
                    {{-- <tr>
                        <td>
                            <img src="{{ ('frontend/images/man.png') }}" alt="" height="60" />
                        </td>
                    ...
                    {{-- <tr>
                        ...
                        <td class="align-middle">Alex right</td>
        ...
        <div class="col-lg-4">
            ...
            <table class="trip-informations">
                ...
                <td width="50%" class="text-right">Rp{{ $item->travel_package->price }},00/person</td>
                </tr>
                <tr>
                <th width="50%">Sub Total</th>
                <td width="50%" class="text-right">Rp{{ $item->transaction_total }},00</td>
                </tr>
                <tr>
                <th width="50%">Total (+Unique)</th>
                <td width="50%" class="text-right text-total">
                    <span class="text-blue">Rp{{ $item->transaction_total }},00</span><span class="text-orange"> {{ mt_rand(0,99) }}</span>
                </td>
                </tr>
            </table>
