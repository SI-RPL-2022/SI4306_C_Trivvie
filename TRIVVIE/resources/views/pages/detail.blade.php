          ...
          <div class="card card-details">
            ...
            <div class="gallery">
              ...
              {{-- <p>
                ...
                numerous Buddhist temples, Shinto shrines, palaces and gardens, some of which are listed collectively by
                UNESCO as a World Heritage Site.
              </p>
              <p>
                Prominent landmarks include the Kyoto Imperial Palace, Kiyomizu-dera, Kinkaku-ji, Ginkaku-ji and the
                Katsura Imperial Villa. Kyoto is also a center of higher learning, with Kyoto University being an
          ...
          <div class="card card-details card-right">
            ...
            <table class="trip-informations">
              <tr>
                ...
                <td width="50%" class="text-right">{{ \Carbon\Carbon::create($item->date_of_departure)->format('F n,
                  Y')}}</td>
              </tr>
              <tr>
